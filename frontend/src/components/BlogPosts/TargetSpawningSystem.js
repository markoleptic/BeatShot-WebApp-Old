...
import image_Hero from "../../images/SpawnMemory_Hero_Cropped.png";
import image_BoxBounds from "../../images/BoxBounds.png";
import image_OverlappingVerts from "../../images/OverlappingVerts.png";
import image_SpawnMemory_Dynamic_FewRecent from "../../images/SpawnMemory_Dynamic_FewRecent.png";
import image_SpawnMemory_Dynamic_ManyRecent from "../../images/SpawnMemory_Dynamic_ManyRecent.png";
...
const TargetSpawningSystem = () => {
  ...
  return (
    <>
      <SEO
        title={"Target Spawning System | BeatShot"}
        type={"article"}
        description={
        ...
        image={image_TargetSpawningSystem_teaser}
        imageAlt="BeatShot in-game debugging visual"
      />
      <div className="flex-container-column">
        <div className="hero-container">
          <div className="hero">
            ...
            <img className="hero-image" src={image_Hero} alt="logo" />
          </div>
        </div>
                  ...
                  <div>
                    ...
                    <figure>
                      <div className="figure-border-container">
                        <img src={image_BoxBounds} alt="BoxBounds" />
                        <figcaption>
                ...
                <div ref={Ref_UProjectileMovementComponent} id="classes-UProjectileMovementComponent">
                  ...
                  <div>
                    <p>
                      ...
                      <BSInlineCodeBlock code={"ATarget"} padding={"0"} />
                      <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                      <BSInlineCodeBlock code={"SetTargetDirection"} color={"rgb(80, 250, 123)"} padding={"0"} /> when
                      it wants to change the velocity or direction. These also happen to be Target Activation Responses.
                    </p>
                    <p>
                ...
                <div ref={Ref_UBSHealthComponent} id="classes-UBSHealthComponent">
                  ...
                  <div>
                    <p>
                      ...
                      OnHealthChanged delegate to its <BSInlineCodeBlock code={"ATarget"} padding={"0"} />
                      <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
              ...
              <div className="article-subsection" ref={Ref_Spawning} id="target-lifecycle-Spawning">
                ...
                <div>
                  ...
                  <p>
                    ...
                    targets based on beat thresholds being met by the audio analyzer, which triggers the game mode to
                    call <BSInlineCodeBlock code={"ATargetManager"} padding={"0"} />
                    <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                    <BSInlineCodeBlock code={"OnAudioAnalyzerBeat"} color={"rgb(80, 250, 123)"} padding={"0"} />. I
                    discuss this function more in the Activation section, but for now I want to focus on what happens
                    when any target is spawned, regardless of the Target Spawning Policy.
                  </p>
                  ...
                  <p>
                    ...
                    <BSInlineCodeBlock
                      ...
                      padding={"0"}
                    />{" "}
                    is called. This function finds all surrounding SpawnAreas that would cause an overlap if a target
                    with the same radius is spawned inside that SpawnArea. This is done by tracing a sphere centered at
                    the location the target was spawned inside the SpawnArea. These traced spheres are shown in Figure 2
                    as purple wireframes, while the red and green points are the center of individual SpawnAreas.
                  </p>
                  <figure>
                    <div className="figure-border-container">
                      <img src={image_OverlappingVerts} alt="OverlappingVerts" />
                      <figcaption>
              ...
              <div className="article-subsection" ref={Ref_Activation} id="target-lifecycle-Activation">
                ...
                <div>
                  <p>
                    ...
                    <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                    <BSInlineCodeBlock code={"OnAudioAnalyzerBeat"} color={"rgb(80, 250, 123)"} padding={"0"} />. If
                    using a song from a file, this would occur exactly Spawn Beat Delay seconds before you actually hear
                    the beat.
                  </p>
                  ...
                  <p>
                    ...
                    <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                    <BSInlineCodeBlock
                      code={"HandleActivateExistingTargets"}
                      color={"rgb(80, 250, 123)"}
                      padding={"0"}
                    />
                    .
                  ...
                  <p>
                    ...
                    either a random target scale between the Min and Max Target Scale or a dynamic target scale taken
                    from a curve based on the number of recent targets successfully destroyed.
                  </p>
                  <p>
                    The SpawnArea containing the next target location is found using{" "}
                    <BSInlineCodeBlock code={"ATargetManager"} padding={"0"} />
                    <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                    <BSInlineCodeBlock code={"GetNextSpawnArea"} color={"rgb(80, 250, 123)"} padding={"0"} /> , which
                    goes through several checks to see if it can spawn at the origin or get a SpawnArea from the RL
                    Component, but the main thing I want to focus on is when it calls{" "}
                    <BSInlineCodeBlock code={"USpawnAreaManagerComponent"} padding={"0"} />
                    <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                    <BSInlineCodeBlock code={"GetValidSpawnLocations"} color={"rgb(80, 250, 123)"} padding={"0"} />.
                  ...
                  <p>
                    ...
                    <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                    <BSInlineCodeBlock code={"Static"} color={"rgb(241, 250, 140)"} padding={"0"} />. Referring to
                    Figure 3, the red boxes outside the the current spawn area (blue box) are the SpawnAreas this
                  ...
                  <figure>
                    <div className="figure-border-container">
                      <img src={image_SpawnMemory_Dynamic_FewRecent} alt="SpawnMemory_Dynamic_FewRecent2" />
                      <figcaption>
              ...
              <div className="article-subsection" ref={Ref_Deactivation} id="target-lifecycle-Deactivation">
                ...
                <div>
                  ...
                  <p>
                    ...
                    <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                    <BSInlineCodeBlock code={"Dynamic"} color={"rgb(241, 250, 140)"} padding={"0"} />. The struct is
                    then forwarded to the game mode which updates the score and player HUD. The target is removed from
                  ...
                  <p>
                    ...
                    <BSInlineCodeBlock code={"::"} color={"white"} padding={"0"} />
                    <BSInlineCodeBlock
                      code={"HandleRecentTargetRemoval"}
                      color={"rgb(80, 250, 123)"}
                      padding={"0"}
                    />{" "}
                  ...
                  <figure>
                    <div className="figure-border-container">
                      <img src={image_SpawnMemory_Dynamic_ManyRecent} alt="SpawnMemory_Dynamic_ManyRecent" />
                      <figcaption>
